...
import { QueryAutocompletePrediction } from '../models/search.interface';
...
export class GooglePlacesService {
  ...
  public setTargetLocationData(data: TargetSearchLocationData) {
    this.targetSearchLocationData$ = new Observable((obs: any) => {
      obs.next(data);
    })
  }
  ...
  public getPlacePredictions(input: string, requestConfig: google.maps.places.AutocompletionRequest = {input, types: ['geocode']}): Observable<google.maps.places.QueryAutocompletePrediction[]> {
